...
static TileBuildings BuildingMap =
{
    ...
    {631u, {TileBuilding(std::string("Icecrownraid_Arthas_Precipice.wmo.vmo"), 503.619781494140625, -2124.654541015625, 836.60699462890625, 3.141592741012573242, 0, 0, 0, 0, 9256, true, true, 0, 202078)}},
    {631u, {TileBuilding(std::string("Icecrownraid_Arthas_Precipice_Phase0.wmo.vmo"), 503.619781494140625, -2124.654541015625, 836.60699462890625, 3.141592741012573242, 0, 0, 0, 0, 9276, false, true, 0, 202161)}},
    {631u, {TileBuilding(std::string("Icecrownraid_Arthas_Precipice_Phase1.wmo.vmo"), 503.619781494140625, -2124.654541015625, 836.60699462890625, 3.141592741012573242, 0, 0, 0, 0, 9276, false, true, 0, 202161)}},
    {631u, {TileBuilding(std::string("Icecrownraid_Arthas_Precipice_Phase2.wmo.vmo"), 503.619781494140625, -2124.654541015625, 836.60699462890625, 3.141592741012573242, 0, 0, 0, 0, 9276, false, true, 0, 202161)}},
    {631u, {TileBuilding(std::string("Iceshard_Standing.m2.vmo"), 473.7476806640625, -2096.47705078125, 840.85699462890625, 3.141592741012573242, 0, 0, 0, 0, 9227, false, true, 0x1, 202141)}},
    {631u, {TileBuilding(std::string("Iceshard_Standing.m2.vmo"), 473.748291015625, -2152.832275390625, 840.85699462890625, -1.57079577445983886, 0, 0, 0, 0, 9227, false, true, 0x1, 202142)}},
    {631u, {TileBuilding(std::string("Iceshard_Standing.m2.vmo"), 533.56048583984375, -2152.831298828125, 840.85699462890625, 0, 0, 0, 0, 0, 9227, false, true, 0x1, 202143)}},
    {631u, {TileBuilding(std::string("Iceshard_Standing.m2.vmo"), 533.55987548828125, -2096.47607421875, 840.85699462890625, 1.570795774459838867, 0, 0, 0, 0, 9227, false, true, 0x1, 202144)}},
};
